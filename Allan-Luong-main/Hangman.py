...
for i in range(7):
    ...
    images.append(image)
    image_path = os.path.join(os.path.dirname(__file__), "images", f"hangman{i}.png")
image = pygame.image.load(image_path)


# game variables
hangman_status = 0
words = ["REPLIT", "PYGAME", "AUDIBLE", "WORDLE", "APPLE", "BRIDGE", "CANDLE", "DRAGON", "FEATHER", "GALAXY", "JUPITER", "NEBULA", "ORBIT", "PRISM", "QUARTZ", "RAVEN", "WINNER", "BLOSSOM", "CANYON", "DAZZLE", "EMBER", "FROST", "GLIMMER", "HARMONY", "INKLING", "KINDLE", "LANTERN", "MIRAGE", "NOVA", "OPAL", "PETAL", "QUILL", "SERENE", "UNISON", "VIOLET", "XYLEM", "YEARN", "ABYSS", "BEACON", "CRIMSON", "DELTA", "EMBER", "FRAGMENT", "GLACIER", "HALO", "SIGMA", "RIPPLE", "UNITY", "VORTEX", "WALTZ", "LOSER", "YAWN", "AEON", "EERIE", "OASIS", "ALIEN", "ELIXIR", "ENIGMA", "IDEAL", "IRONMAN", "OBLIVION", "SIGIL", "EUROPE", "UTOPIA", "IMAGINE", "OPTIMIZE", "EMERGE", "ELEVATE", "ESCAPE", "ORIGAMI"]
